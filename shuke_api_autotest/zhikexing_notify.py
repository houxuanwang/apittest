...
def dingding_robot(data):
    ...
    webhook3="https://im.360teams.com/api/qfin-api/rce-app/robot/send?access_token=00ba3234bb9a4fa3b893401cf03cc64bfd423110a21b48abbbf13e52976e00f3"
...
def notify_autotest_result(file: str, job: str) -> None:
    ...
    jenkins_auto = "http://jenkins1-test.qihoo.net/jenkins/view/自动化接入项目/job/autotest_zhikexing/{}/allure/"
    ...
    body = {
        "msgtype": "text",
        "text": {
            "content": f"智能接口自动化测试报告：\n" +
                       f"> 【用例总数】：{total:<9}\n\n" +
                       f"> 【成功用例数】：{passed:<9}\n\n" +
                       f"> 【失败用例数】：{failed:<9}\n\n" +
                       f"> 【跳过用例数】：{skipped:<9}\n\n" +
                       f"> [请点击报告链接查看详情!]http://jenkins1-test.qihoo.net/jenkins/view/Autotest/job/shuke_zhikexing/{job}/allure/ \n "
        },
    }
